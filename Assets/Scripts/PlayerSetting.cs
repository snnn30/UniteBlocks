...
namespace UniteBlocks
{
    ...
    {
        [SerializeField, Range(0f, 5f)] float m_AutoDropDelay = 0.48f;
        [SerializeField, Range(0f, 5f)] float m_ManualDropDelay = 0.06f;
        [SerializeField, Range(0f, 5f)] float m_StagnationTime = 0.5f;
        [SerializeField, Range(0f, 5f)] float m_MoveDelay = 0.08f;
        [SerializeField, Range(0f, 5f)] float m_RotateDelay = 0.12f;
